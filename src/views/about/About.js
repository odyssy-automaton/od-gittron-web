    ...
    <div className="Page About">
      <div className="PageHeader">
        <div className="PageHeader__Contents">
          <h1>
            The year is 3369 and, throughout the universe, all biological life
            has been decimated. All that's left are Prime Bots that Humans sent
            to explore space. It's up to the Prime Bots to buidl their own
            future. They'll need help from the Worker and Support Bots in order
            to survive.
          </h1>
        </div>
      </div>
      <div className="Block Columns Contain">
        <div className="Columns__Column--33">
          ...
          <p>
            Donate to any open source project on Gittron and get a Support Bot
            NFT.
          </p>
        </div>
        <div className="Columns__Column--33">
        ...
        <div className="Columns__Column--33">
          ...
          <p>
            When a bot is generated, your codebase is used to generate it's DNA.
          </p>
        </div>
      </div>
      ...
      <div className="Block">
        <div className="Block__Contents Contain">
          ...
          <p>
            Authenticate with Web3 Wallet and go to Dashboard. In Dashboard, you
            can register a new repo. Set a price for how much you want to accept
            per Support Bot and a Wallet Address to receive the funds from
            supports.
          </p>
          <p>
          ...
          <p>
            <strong>Who built this silly thing?</strong>
          </p>
          <p>
            Odyssy is a decentralized collective sending design and development
            to blockchain and beyond. Connect with us at{' '}
            <a
